...
public class ConverterTests {
  ...
  @Test
  public void convertsK8sObjectWithNoAuthToModel()
  throws JsonProcessingException {
    K8sTrainingPortalToTrainingPortal converter = new K8sTrainingPortalToTrainingPortal();
    ...
    V1beta1TrainingPortal k8sPortal = mapper.readValue(
      ...
      TrainingPortal modelPortal = converter.convert(k8sPortal);
      assertThat(modelPortal, is(notNullValue()));
      assertThat(modelPortal.getAuthType(), is(TrainingPortal.AuthType.ONE_STEP));
      assertThat(modelPortal.getPortalPassword(), is(nullValue()));
  }

  @Test
  public void convertsK8sObjectWithRegistrationToModel()
  throws JsonProcessingException {
    K8sTrainingPortalToTrainingPortal converter = new K8sTrainingPortalToTrainingPortal();
  ...
  @Test
  public void convertsK8sObjectWithNoAuthTypeAndPortalPasswordToModel()
  throws JsonProcessingException {
    K8sTrainingPortalToTrainingPortal converter = new K8sTrainingPortalToTrainingPortal();
    ...
    V1beta1TrainingPortal k8sPortal = mapper.readValue(
      ...
      assertThat(modelPortal, is(notNullValue()));
      assertThat(modelPortal.getAuthType(), is(TrainingPortal.AuthType.ONE_STEP));
      assertThat(modelPortal.getPortalPassword(), is("FAKEPORTALPASSWORD"));
  }

  @Test
  public void convertsK8sObjectWithAnonymousAuthAndPortalPasswordToModel()
  throws JsonProcessingException {
    K8sTrainingPortalToTrainingPortal converter = new K8sTrainingPortalToTrainingPortal();
    ...
    V1beta1TrainingPortal k8sPortal = mapper.readValue(
      ...
      TrainingPortal modelPortal = converter.convert(k8sPortal);
      assertThat(modelPortal, is(notNullValue()));
      assertThat(modelPortal.getAuthType(), is(TrainingPortal.AuthType.ANONYMOUS));
      assertThat(modelPortal.getPortalPassword(), is("FAKEPORTALPASSWORD"));
  }
}
