package com.vmware.tanzu.se.waasportal.service.educates;
...
import com.vmware.tanzu.se.waasportal.service.EducatesApiService;
...
public class TrainingPortalServiceEducatesTests {
    ...
    public void setup () {
        ...
        wireMockServer.stubFor(
            get(urlPathEqualTo("/apis/training.educates.dev/v1beta1/trainingportals")).atPriority(1)
        ...
        wireMockServer.stubFor(
            get(urlMatching("/apis/training.educates.dev/v1beta1/trainingportals?.*")).atPriority(5)
            .willReturn(aResponse()
                .withBody(
                    """
                    {
            ...
            .willReturn(aResponse()
                .withBody(
                    """
                    {
                        ...
                        "groups": [
                            {
                                "name": "training.educates.dev",
                                "versions": [
                                  {
                                    "groupVersion": "training.educates.dev/v1beta1",
                                    "version": "v1beta1"
                                  }
                                ],
                                "preferredVersion": {
